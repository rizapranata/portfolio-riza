...
export default function Home() {
  return (
    <>
          ...
          <div className="flex flex-wrap">
            <div className="w-full self-center px-4 lg:w-1/2">
              ...
              <p className="font-medium text-secondary mb-10 leading-relaxed">
                Someone who loves the world of software developers
              </p>
          ...
          <div className="flex flex-wrap">
            ...
            <div className="w-full px-4 lg:w-1/2">
              ...
              <p className="font-medium text-base text-justify text-secondary mb-6 max-w-xl lg:text-lg">
                Here are some of the technologies that I often use in creating a
                project.
              </p>
      ...
      <section id="portfolio" className="pt-[20px] pb-16 bg-slate-100 lg:pt-36">
        <div className="container">
          <div className="w-full px-4">
            <div className="max-w-xl mx-auto text-center mb-16">
              ...
              <p className="font-medium text-md text-secondary md:text-lg">
                Some of the last projects I worked on
              </p>
            </div>
          </div>
          <div className="w-full px-4 flex flex-wrap justify-center xl:w-10/12 xl:mx-auto">
            <div className="mb-6 p-4 md:w-1/2">
              <div className="rounded-md shadow-md overflow-hidden">
                <Image src={arjunaPort} alt={"port-1"} className="w-full" />
              </div>
              ...
              <p className="text-secondary">
                ...
                leave requests, overtime submissions, accessing employee
                benefits, and processing claims.
              </p>
            </div>
            <div className="mb-6 p-4 md:w-1/2">
              <div className="rounded-md shadow-md overflow-hidden">
                <Image src={octorSmart} alt={"port-1"} className="w-full" />
              </div>
              <h3 className="font-semibold text-xl text-dark mt-5 mb-3">
                Project Octo Smart CC Supplement
              </h3>
              <p className="text-secondary">
                The Supplementary Credit Card feature allows CIMB Niaga primary
                credit card holders to provide credit access to family members
            ...
            <div className="mb-6 p-4 md:w-1/2">
              <div className="rounded-md shadow-md overflow-hidden">
                <Image src={wm} alt={"port-1"} className="w-full" />
              </div>
              <h3 className="font-semibold text-xl text-dark mt-5 mb-3">
                Octo Smart Wealth Management
              </h3>
              <p className="text-secondary">
                ...
                transactions for purchases (subscriptions), redemptions, and
                switches without having to visit a branch office.
              </p>
            </div>
            <div className="mb-6 p-4 md:w-1/2">
              <div className="rounded-md shadow-md overflow-hidden">
                <Image src={djpmobile} alt={"port-1"} className="w-full" />
              </div>
              <h3 className="font-semibold text-xl text-dark mt-5 mb-3">
                M-Pajak
              </h3>
              <p className="text-secondary">
                M-Pajak is the official application from the Directorate General
                of Tax (DJP) designed to facilitate taxpayers in managing their
                tax obligations through mobile devices.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="client" className="pt-[20px] pb-32 bg-slate-700 lg:pt-36">
        <div className="w-full px-4">
      ...
      <section id="contact" className="pt-[20px] pb-32 lg:pt-36">
        <div className="container">
          <div className="w-full px-4">
            <div className="mx-auto text-center mb-16">
              <h4 className="font-semibold text-lg text-primary mb-2">
      ...
      <footer id="footer" className="pt-24 pb-12 bg-dark">
        <div className="container">
          <div className="flex flex-wrap">
            ...
            <div className="w-full px-4 mb-12 text-slate-300 md:w-1/3">
              <h2 className="font-bold text-xl text-white mb-5">Category</h2>
          ...
          <div className="w-full pt-10 border-t border-slate-700">
            <div className="flex items-center justify-center mb-5">
              {/* instagram */}
              <Link
                href="https://www.instagram.com/rizapranata/"
                target="_blank"
